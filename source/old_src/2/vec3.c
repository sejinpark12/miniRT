...
/*   Updated: 2020/11/19 12:38:30 by sejpark          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
//	t_vec3	*result;
//
//	if (NULL == (result = (t_vec3*)malloc(sizeof(t_vec3))))
//		return (NULL);
...
//{
//	return (ft_vec3_multiply_float((1 / t), v));
//}
...
//{
//	return (ft_vec3_divide_float(ft_vec3_length(v), v));
//}
